...
public class ScheduleServiceTest {
    ...
    public void update() {
        ...
        Schedule schedule = scheduleServiceImpl.update(updatedSchedule);
    ...
    public void sendScheduleToTeachers() throws MessagingException {
        ...
        verify(mailService, times(id.length))
    ...
    public void sendScheduleToTeacher() throws MessagingException {
        ...
        when(scheduleRepository.getDaysWhenTeacherHasClassesBySemester(anyLong(), anyLong()))
                .thenReturn(dayOfWeeks);
        when(temporaryScheduleService.getTemporaryScheduleForEvenOddWeeks(any()))
                .thenReturn(temporarySchedules);
    ...
    public void scheduleForGroupedLessons() {
        ...
        when(lessonService.getAllGroupedLessonsByLesson(lesson))
                .thenReturn(Arrays.asList(lesson2, lesson));
    ...
    public void getAllOrderedByRoomsDaysPeriodsTest() {
        ...
        when(scheduleRepository.getAllOrdered(1L))
